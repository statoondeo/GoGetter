...
public sealed class GoGetterData
{
	...
	public static IList<GoGetterTile> GetTiles()
		...
		{
			new GoGetterTile((2, 3)),
			new GoGetterTile((0, 3)),
			new GoGetterTile((1, 2)),
			new GoGetterTile((0, 1), (2, 3)),
			new GoGetterTile((0, 2), (1, 3)),
			new GoGetterTile((0, 1), (0, 3)),
			new GoGetterTile((0, 3), (1, 2)),
			new GoGetterTile((0, 1), (0, 2), (1, 2)),
			new GoGetterTile((0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (2, 3)),
		};
}
